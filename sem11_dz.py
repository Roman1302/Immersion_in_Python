...
if __name__ == '__main__':
    ...
    print("matrix_1", matrix_1, "matrix_2", matrix_2, "matrix_3", matrix_3, sep='\n', end='\n==========\n')
    print("matrix_1 == matrix_2", matrix_1 == matrix_2, end='\n=======\n')
    print("matrix_1 == matrix_3", matrix_1 == matrix_3, end='\n<<<<<<<<<<<\n')
    print("matrix_1 < matrix_2", matrix_1 < matrix_2, end='\n>>>>>>>>>>>>\n')
    print("matrix_1 > matrix_2", matrix_1 > matrix_2, end='\n++++++++++++\n')
    add_matrix = matrix_1 + matrix_3
    print("matrix_1 + matrix_3", add_matrix, sep='\n', end='\n***********\n')
    mul_matrix = matrix_1 * matrix_2
    print("matrix_1 * matrix_2", mul_matrix, sep='\n', )
