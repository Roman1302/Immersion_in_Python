...
import os
from loggings import general_journal
...
def walk_dir(path_string: str):
    ...
    if not path_string:
        ...
        general_journal.warning(f'Путь установлен по умолчанию {path_string}')
    ...
    try:
        ...
        general_journal.info(msg=str(fs_objects[-1]))
    except Exception as exc:
        print(f'\033[31mERRORR: {exc.__class__.__name__}: {exc}\033[0m')
        general_journal.error(msg=f'{exc.__class__.__name__}: {exc}')
